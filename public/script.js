    ...
    function handleCommand(command) {
        switch (command) {
            case 'about':
                ...
                break;
            case 'projects':
                output.innerHTML += '<div class="command-output">' + prompt.outerHTML + 'projects:</br><ul><li><a href="https://dangerline.deno.dev/">DangerLine</a> WIP: Description of Project A</li><li>Basic WIP: Description of Project B</li></ul></div>';
                break;
            case 'services':
